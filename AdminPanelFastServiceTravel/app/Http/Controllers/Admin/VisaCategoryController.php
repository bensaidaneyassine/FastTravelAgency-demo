...
class VisaCategoryController extends Controller
{
    public function index()
    {
        ...
        return view("admin.visa.category.index",compact('categories'));
    }
    ...
    public function create()
    {
        ...
        $categories = Category::where('type','=','visa-category')->get();
        return view("admin.visa.category.create",compact('categories','languages'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $category->save();
        return redirect()->route('admin.visa.category.index')->with(['type' => 'success', 'message' =>'Category Saved.']);
    }
    ...
    public function edit($id)
    {
        ...
        $languages = Option::where('key','=','language')->get();
        return view('admin.visa.category.edit',compact('category','categories','languages'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $category->language = $request->language;
        $category->save();
        return redirect()->route('admin.visa.category.edit',$id)->with(['type' => 'success', 'message' =>'Category Updated.']);
    }
    ...
    public function destroy($id)
    {
        ...
        $category->delete();
        $slug_id->forceDelete();
        return redirect()->route('admin.visa.category.index')->with(['type' => 'success', 'message' =>'Category Deleted.']);
    }
}
