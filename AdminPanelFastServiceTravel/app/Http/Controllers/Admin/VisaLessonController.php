...
class VisaLessonController extends Controller
{
    ...
    {
        return view('admin.visa.lesson.create',compact('country','topic'));
    }
    ...
    public function store(Request $request,$country,$topic)
    {
        ...
        return redirect()->route('admin.visa.country.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.visa.lesson.edit',compact('lesson'));
    }
