...
@section('content')
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.visa.student.index') }}">{{ __('main.Students') }}</a></li>
    ...
    <div class="content">
        <div class="container-fluid">
            <form action="{{ route('admin.visa.student.update',$user->id) }}" method="post" id="form">
                @method('PUT')
                @csrf
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="country">{{ __('main.Countries') }}</label>
                                ...
                                <div id="countries">
                                    ...
                                    <div class="row mx-0 mb-1 border-bottom">
                                        ...
                                        <span>{{App\Models\Country::find($value)->title}}</span>
...
<script>
    $('#country').change(function(){
        ...
        var title = $('#country option:selected').html();
        if(id!=""){
            $('#countries').append('<div class="row mx-0 mb-1 border-bottom"><input type="hidden" name="metas[student_courses]['+id+']" value="'+title+'"><span>'+title+'</span><a class="btn btn-xs btn-danger ml-auto px-2" href="javascript:void(0);" onclick="this.parentNode.remove()">&times;</a></div>')
        }
    });
    $("#pass").click(function(){
