  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4 class="m-0 text-dark">{{ __('main.Add New Country') }}</h4>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">{{ __('main.Home') }}</a></li>
                <li class="breadcrumb-item"><a href="{{ route('admin.visa.country.index') }}">{{ __('main.Visas') }}</a></li>
              <li class="breadcrumb-item active">{{ __('main.Add New Country') }}</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="content">
        <div class="container-fluid">
            <form action="{{ route('admin.visa.country.store') }}" method="post" id="form">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3" for="total_time">{{ __('main.Total Country Time') }}</label>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <label for="">{{ __("main.Countries Intro video") }}</label>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <label>{{ __("main.Countries Type") }}</label>
                            </div>
                            <div class="card-body">
                                <div class="form-group">
                                    <label class="mr-3">
