...
@section('content')
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{ route('admin.visa.country.index') }}">{{ __('main.Countries') }}</a></li>
    ...
    <div class="content">
        <div class="container-fluid">
            <form action="{{ route('admin.visa.lesson.update',$lesson->id) }}" method="post" id="form">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <img src="{{ ($lesson->getMedia->id==1) ? '' : $country->getMedia->getUrl() ?? ''}}" alt="" id="media_img" class="w-100">
                            </div>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <label class="mr-3">
                                        ...
                                        {{ __('main.Enable Country Preview') }}
                                    </label>
                                    <small>
                                        {{ __('main.If checked, any users/guest can view this lesson without enroll country')}}</small>
                                </div>
                            </div>
                        </div>
                    </div>
