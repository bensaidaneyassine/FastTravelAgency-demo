        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('admin.visa.category.create') }}" class="btn btn-success btn-sm">{{ __('main.Add New') }}</a>
                </div>
                <div class="card-body">
                            ...
                            @foreach ($invoices as $category)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('admin.visa.category.edit',$category->id) }}" title="{{ __('main.Edit') }}" class="btn btn-primary btn-xs"><i class="fas fa-pencil-alt"></i></a>
                                        <form id="delete_{{$category->id}}" action="{{route('admin.visa.category.destroy',$category->id)}}" method="post" class="d-inline">
                                            @method('DELETE')
                                            @csrf
