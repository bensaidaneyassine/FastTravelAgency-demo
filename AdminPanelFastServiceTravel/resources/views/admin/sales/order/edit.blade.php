...
@section('content')
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.visa.category.index') }}">{{ __('main.Categories') }}</a></li>
    ...
    <div class="content">
        <div class="container-fluid">
            <form action="{{ route('admin.visa.category.update',$category->id) }}" method="post" id="form">
                @method('PUT')
                @csrf
                <input type="hidden" name="media_id" id="media_id" value="{{$category->getMedia->id}}">
                <input type="hidden" value="visa-category" name="type">
                <div class="row">
                    <div class="col-md-9">
                        <div class="card">
                            <div class="card-body">
