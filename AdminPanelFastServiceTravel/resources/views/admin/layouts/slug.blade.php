...
if (isset($article)) {
    ...
    $seo_title = $country->getSlug->seo_title;
    $seo_description = $country->getSlug->seo_description;
    $no_index = $country->getSlug->no_index;
    $no_follow = $country->getSlug->no_follow;
} else {
    $seo_title = '';
    $seo_description = '';
    $no_index = 0;
