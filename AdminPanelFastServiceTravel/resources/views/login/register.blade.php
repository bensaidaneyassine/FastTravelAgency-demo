...
<head>
  ...
  <title>Fast Service Travel {{ __('main.Register') }}</title>
...
<body class="hold-transition register-page">
  <div class="register-box">
    <div class="register-logo">
      <a href="{{url('/')}}"><b>Fast</b> Service Travel</a>
    </div>
    ...
    <div class="card">
      <div class="card-body register-card-body">
        ...
        <form action="{{route('register')}}" method="post">@csrf
          ...
          <div class="input-group mb-3">
            <input type="text" class="form-control" placeholder="{{ __('main.Phone') }}" name="phoneNumber" required>
            <div class="input-group-append">
              <div class="input-group-text">
          ...
          <div class="input-group mb-3">
            <input type="password" class="form-control" placeholder="{{ __('main.Retype password') }}" name="password_confirmation" required>
            <div class="input-group-append">
              <div class="input-group-text">
                <span class="fas fa-lock"></span>
              </div>
          ...
          <!-- Role selection removed: default role=user -->
          <div class="row">
            <div class="col-8">
